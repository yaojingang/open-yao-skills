...
## 2026-04-27T14:56:29+08:00
- Summary: Added narrative background, conflict framing, user-question framing, solution path, and plain Kelly-principle section to HTML reports.
- Reason: The user wanted reports to explain the situation story, tension, user doubt, recommended solution, Kelly principle, and then the detailed method.
- Files: `scripts/kelly_allocation_report.py`, `scripts/generate_html_report.py`, `references/output-contract.md`, `reports/marketing-budget-brief.json`, `reports/marketing-budget-output.json`, `reports/marketing-budget-report.html`, `reports/engineering-hours-brief.json`, `reports/engineering-hours-output.json`, `reports/engineering-hours-report.html`, `reports/example-html-report.html`, `history/CHANGELOG.md`
- Assumptions: `Narrative context should be part of the brief and preserved in canonical JSON so HTML is not inventing case-specific facts.`
- Checks: `python3 scripts/kelly_allocation_report.py --input reports/marketing-budget-brief.json --output reports/marketing-budget-output.json`, `python3 scripts/kelly_allocation_report.py --input reports/engineering-hours-brief.json --output reports/engineering-hours-output.json`, `python3 scripts/generate_html_report.py --input reports/marketing-budget-output.json --output reports/marketing-budget-report.html`, `python3 scripts/generate_html_report.py --input reports/engineering-hours-output.json --output reports/engineering-hours-report.html`, `python3 /Users/laoyao/AI Coding/03-Development/Skills/yao-meta-skill/scripts/validate_skill.py /Users/laoyao/AI Coding/03-Development/Skills/yao-kelly-skill`
- Next steps: `Add context fields to the intake contract if more real user cases use this narrative structure.`

## 2026-05-04T10:45:26+08:00
- Summary: Refactored Kelly skill logic into a practical resource allocation coach with fit assessment, resource snapshot, minimum action packages, and review loop.
- Reason: The user observed that the formula-centered skill still felt insufficiently useful for ordinary users.
- Files: `SKILL.md`, `README.md`, `references/intake-contract.md`, `references/output-contract.md`, `scripts/kelly_allocation_report.py`, `scripts/generate_html_report.py`, `reports/internet-product-sprint-brief.json`, `reports/internet-product-sprint-output.json`, `reports/internet-product-sprint-report.html`, `reports/marketing-budget-output.json`, `reports/marketing-budget-report.html`, `reports/engineering-hours-output.json`, `reports/engineering-hours-report.html`, `history/CHANGELOG.md`
- Assumptions: `Kelly should be treated as a sizing engine behind a practical allocation workflow, not as the main user-facing product.`
- Checks: `python3 scripts/kelly_allocation_report.py --input reports/internet-product-sprint-brief.json --output reports/internet-product-sprint-output.json`, `python3 scripts/generate_html_report.py --input reports/internet-product-sprint-output.json --output reports/internet-product-sprint-report.html`, `python3 /Users/laoyao/AI Coding/03-Development/Skills/yao-meta-skill/scripts/validate_skill.py /Users/laoyao/AI Coding/03-Development/Skills/yao-kelly-skill`
- Next steps: `Review whether the default report should hide technical tables behind collapsible sections for even simpler first-read experience.`
